...
$(eval $(call build-test,BUILD_EVERYTHING,0x60001,-De4__BUILD_EVERYTHING))
$(eval $(call build-test,BUILD_DEFAULT,0x60001,-De4__BUILD_DEFAULT))
$(eval $(call build-test,BUILD_MINIMAL,0,-De4__BUILD_MINIMAL))

# Test excluding any single word set.
$(eval $(call build-test,BUILD_NO_CORE_EXT,0x60000,\
	-De4__BUILD_EVERYTHING -De4__EXCLUDE_CORE_EXT))
$(eval $(call build-test,BUILD_NO_TOOLS,0x40001,\
	-De4__BUILD_EVERYTHING -De4__EXCLUDE_TOOLS))
$(eval $(call build-test,BUILD_NO_TOOLS_EXT,0x20001,\
